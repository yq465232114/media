...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
     ...
     * 初始化摄像头
     */
    public void initCamera(boolean flag) throws IOException {
        pflag=flag;
        if (camera != null) {
            freeCameraResource();
        }
        try {
            if (flag&&checkCameraFacing(Camera.CameraInfo.CAMERA_FACING_BACK)) {
...
//        LogUtil.e(LOG_TAG,"手机支持的最大像素supportedPictureSizes===="+sizePicture);
        ...
        mediaRecorder.setOrientationHint(90);//输出旋转90度，保持竖屏录制
            ...
            mediaRecorder.setOrientationHint(270);//输出旋转270度，保持竖屏录制
